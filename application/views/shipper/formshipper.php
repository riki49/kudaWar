<?php
  ...
  if (isset($m_shipper)){
    $id=$m_shipper->id;
    $nama=$m_shipper->nama;
    $alamat=$m_shipper->alamat;
    $pic=$m_shipper->pic;
    $phone=$m_shipper->phone; 
  }
  ?>
<!DOCTYPE html>
<html>
...
<section class="content">
      <div class="row">
        ...
        <div class="col-xs-12">
        <a href="<?php echo base_url()?>shipper"><button type="button" class="btn bg-olive btn-flat margin"><- Kembali</button></a>
            ...
            <form action="#" method="post" class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">ID Shipper</label>
